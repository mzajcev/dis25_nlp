...
# Initialize global objects: lemmatizer, spell checker, and translator
lemmatizer = WordNetLemmatizer()
spell = SpellChecker()
translator = Translator()

# Define a set of English stop words, excluding some words like 'not', 'against', 'nor', 'no'
...
# Function to clean user's input
def clean_user_input(user_input):
    ...
    # Tokenize the input, i.e., split the text into individual words
    user_input_token = word_tokenize(user_input_en)
    
    # Remove punctuation and make all text lower case
    ...
    # Apply lemmatization, i.e., convert each word to its base form or lemma
