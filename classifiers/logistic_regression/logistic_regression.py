...
def model_training_logistic(x_train, y_train):
...
logistic_model, logistic_vec = model_training_logistic(x_train, y_train)

# Prepare the testing data and labels
x_test = test_df['text']
y_test = test_df['label']

# Transform the testing data using the vectorizer from the logistic model
x_test_logistic = logistic_vec.transform(x_test)

# Predict the labels for the test set using the logistic model
y_pred_logistic = logistic_model.predict(x_test_logistic)

# Calculate and print the accuracy and classification report for the logistic model
...
# joblib.dump(logistic_vec, 'vectors.logistic_regression')
# joblib.dump(logistic_model, 'classifier.logistic_regression')